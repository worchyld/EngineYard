...
"""
    ...
    static let fakeTrain: Train = Train.init(id: UUID(), name: "FakeTrain", avatar: "green-1.png", cost: 4, trainPool: 3, livery: .green, generation: .first, rust: .new, maxDice: 3, initialOrder: nil, existingOrders: nil, completedOrders: nil, factoryProduction: nil)
}
