...
struct Fixtures {
    static var mockLocos: [Card] {
        let greenFirst = Card(id: UUID(), name: "green.1", avatar: "green-1.png", cost: 4, generation: .first, livery: .green )
        let redFirst = Card(id: UUID(), name: "red.1", avatar: "red-1.png", cost: 8, generation: .first, livery: .red )
        let yellowFirst = Card(id: UUID(),  name: "yellow.1", avatar: "yellow-1.png", cost: 12, generation: .first, livery: .yellow )
        let blueFirst = Card(id: UUID(), name: "blue.1", avatar: "blue-1.png", cost: 18, generation: .first, livery: .blue )
