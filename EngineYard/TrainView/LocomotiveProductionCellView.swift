...
struct LocomotiveProductionCellView_Previews: PreviewProvider {
    static var previews: some View {
        LocomotiveProductionCellView(locomotive: LocomotiveViewModel(id: UUID(), name: "Green.1", image: LocomotiveAssetImage.greenTrain, cost: 4, livery: .green, generation: .first, rust: .new, available: false), productionUnits: 3)
    }
}
